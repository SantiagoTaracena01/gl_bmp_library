...
# Librerías importantes para la clase Camera.
...
class Camera(object):
  ...
  # Método constructor de la clase Camera.
  def __init__(self):
  ...
  def load_model_matrix(self, translate=Vector(0, 0, 0), scale=Vector(1, 1, 1), rotate=Vector(0, 0, 0)):
